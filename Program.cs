...
namespace IngameScript
{
    ...
    partial class Program : MyGridProgram
    {
        ...
        public Program()
        {
            ...
            // Value modifier
            _commands["MaxSpeed"] = MaxSpeed ;
            _commands["ApproachDistance"] = () => SetSamValue("ApproachDistance");
        ...
        public void GetSamPbCd()
        {
            ...
            _textToOutput = "ApproachDistance : " + ApproachDistance + " \n";
            _textToOutput += "MaxSpeed : " + MaxSpeed + " \n";
